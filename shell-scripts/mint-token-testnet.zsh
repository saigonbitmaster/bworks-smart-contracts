#!/usr/bin/zsh
# Usage:
# $ ./mint-token-testnet.zsh $tokenName $payment_address $policy_directory_path $tokenamount $txHash
#
# For eg:
# $ ./mint-token-testnet.zsh bworks `cat payment1.addr` bworks-policy 5000 d448e8722cba3abbdfa994ee4cfc6318ebad0e307bb535214979d11bea8bee22
